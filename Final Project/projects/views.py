...
def Edit(request,id):
    if request.method == "POST":
        ...
        try:
            ...
            project.save()
            messages.add_message(request, messages.SUCCESS,"Your Project has been successfully edited.")
            return redirect("/project/")
        except Exception as e:
                messages.add_message(request, messages.ERROR, e)
                return redirect("/project/")
        ...
        messages.add_message(request, messages.ERROR, 'You are not allowed visit this page.')
        return redirect("/project/")
...
def contactSubmit(request):
    ...
    newContact.save()
    messages.add_message(request, messages.INFO,"Your contact form has been submitted. Thank you for visiting our website!")
    return redirect("/")